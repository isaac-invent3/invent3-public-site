...
import AutoBadge from '../Drawers/Common/AutoBadge';

const TicketTitle = ({ data }: { data: Ticket }) => {
  return (
    <HStack maxW="200px" spacing="8px" overflow="hidden">
      <Text color="black" isTruncated noOfLines={1}>
        {data?.ticketTitle}
      </Text>
    ...
    () => {
      const baseColumns = [
        ...
        columnHelper.accessor('ticketTitle', {
          cell: (info) => <TicketTitle data={info.row.original} />,
          header: 'Title',
          enableSorting: false,
        }),
