...
import TicketClosedSourceStatusGraph from './TicketClosedSourceStatusGraph';
import TicketVolumeOverTime from './TicketVolumeOverTime';
import TicketsByPriorityAndTopAssetWithTIckets from './TicketsByPriorityAndTopAssetWithTIckets';
...
const TicketsDashboard = () => {
  ...
  return (
    ...
    >
      ...
      />
      <Summary />
      <TicketClosedSourceStatusGraph />
      <TicketVolumeOverTime />
      <TicketsByPriorityAndTopAssetWithTIckets />
    </Flex>
  );
};
