...
import AnomaliesAndAssetRisk from './AnomaliesAndAssetRisk';
import PredictedFailuresAndTopPerformingPredictionModels from './PredictedFailuresAndTopPerformingPredictionModels';
import ModelAccurracyAndAIHighlights from './ModelAccurracyAndAIHighlights';
import AssetLevelPredictiveSummary from './AssetLevelPredictiveSummary';
    ...
    >
      <VStack width="full" alignItems="flex-start" spacing="8px" pb="26px">
        ...
        <Text color="#6E7D8E" fontWeight={700} size="md">
          Monitor ticket activity, technician performance, and SLA compliance
      ...
      />
      <Summary />
      <AnomaliesAndAssetRisk />
      <PredictedFailuresAndTopPerformingPredictionModels />
      <ModelAccurracyAndAIHighlights />
      <AssetLevelPredictiveSummary />
    </Flex>
  );
};
