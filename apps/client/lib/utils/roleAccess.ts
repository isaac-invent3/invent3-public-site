...
const ROUTES_PERMISSION_KEY: { [name: string]: PermissionKey } = {
  ...
  [`/${ROUTES.ROLES}`]: 'role',
  [`/${ROUTES.ROLES}/role`]: 'role',
  [`/${ROUTES.ROLES}/role/add`]: 'role',
  [`/${ROUTES.ROLES}/role/[id]/detail`]: 'role',
  [`/${ROUTES.ROLES}/group/add`]: 'role',
  [`/${ROUTES.ROLES}/group/[id]/edit`]: 'role',
  ...
  [`/${ROUTES.COMPANY}/[id]/data-upload`]: 'company',
  [`/${ROUTES.SETTINGS}`]: 'settings',
  [`/${ROUTES.COMPLIANCE}`]: 'compliance',
  [`/${ROUTES.FEEDBACK}`]: 'user',
  [`/${ROUTES.COMPLIANCE}/facility/[id]`]: 'compliance',
